...
Дополнительно использовать: разработку через тестирование (TDD), рефакторинг, функциональное программирование.

Организовать выполнение по методике организации совместного рабочего процесса Scrum.
